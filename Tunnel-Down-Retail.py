...
def tunnels(sase_session, endpoint_ip, status, domain):
    domain_id = None
    for domain in sase_session.get.servicebindingmaps().cgx_content["items"]:
...
def go():
    ...
    tunnels(sase_session, endpoint_ip, status, domain)
